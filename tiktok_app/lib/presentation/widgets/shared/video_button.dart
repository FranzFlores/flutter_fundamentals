...
import 'package:tiktok_app/config/helpers/formats.dart';
import 'package:tiktok_app/domain/entities/video_post.dart';

class VideoButton extends StatelessWidget {
  final VideoPost video;

  const VideoButton({required this.video, Key? key}) : super(key: key);
    ...
    return Column(
      children: [
        ...
        SpinPerfect(
          ...
          child: _CustomIconButton(value: video.views, iconData: Icons.play_circle_fill_outlined)),
      ],
    );
  }
}
